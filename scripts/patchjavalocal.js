...
dotenv.set('VITE_APP_BUILD_VERSION', 'java_local');
dotenv.set('VITE_APP_LOCAL_CONTEXT', '/eux');
dotenv.set('VITE_APP_API_BASE_URL', '/eux/api/');
dotenv.set('VITE_APP_JAVA_LOCAL_HOST', DEFAULT_JAVA_SERVER);
