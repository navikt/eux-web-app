...
export const API_RINASAKER_OVERSIKT_FNR_QUERY_URL = V3_BASE_URL + '/person/%(fnr)s/rinasaker/oversikt'
export const API_RINASAKER_OVERSIKT_DNR_QUERY_URL = V3_BASE_URL + '/person/%(fnr)s/rinasaker/oversikt'
export const API_RINASAKER_OVERSIKT_SAKID_QUERY_URL = V3_BASE_URL + '/rina/sak/%(rinaSakId)s/oversikt'
...
export const API_FEILREGISTRER_JOURNALPOSTER_URL = '/rina/sak/%(rinaSakId)s/feilregistrerjournalposter'
