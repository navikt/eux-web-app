...
// Other
export const API_SVARPASED_SAKSNUMMER_URL = API_BASE_URL + "/saksnummer/%(saksnummer)s";
export const API_SVARPASED_SENDSVARPASEDDATA_POST_URL = API_BASE_URL + "/sendsvarpaseddata";
