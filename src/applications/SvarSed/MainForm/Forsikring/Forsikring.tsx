...
import InntektOgTimerFC from 'applications/SvarSed/MainForm/Forsikring/InntektOgTimer/InntektOgTimer'
import {
  validateForsikringPeriode,
  ValidationForsikringPeriodeProps
} from 'applications/SvarSed/MainForm/Forsikring/validation'
...
const Forsikring: React.FC<TwoLevelFormProps> = ({
  options,
  parentNamespace,
  personID,
  personName,
