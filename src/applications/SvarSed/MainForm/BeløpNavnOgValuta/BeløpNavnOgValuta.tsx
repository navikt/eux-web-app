...
const BeløpNavnOgValuta: React.FC<TwoLevelFormProps> = ({
  parentNamespace,
  personID,
  personName,
  replySed,
  ...
  const [_validation, _resetValidation, performValidation] = useValidation<ValidationBeløpNavnOgValutaProps>({}, validateBeløpNavnOgValuta)
