...
interface AnsattSelector extends TwoLevelFormSelector {
...
const Ansatt: React.FC<TwoLevelFormProps> = ({
  parentNamespace,
  personID,
  personName,
  replySed,
  ...
  const [_validationArbeidsperiode, _resetValidationArbeidsperiode, performValidationArbeidsperiode] = useValidation<ValidationArbeidsgiverProps>({}, validateArbeidsgiver)
  ...
  const [_validationPeriode, _resetValidationPeriode, performValidationPeriode] = useValidation<ValidationArbeidsperiodeProps>({}, validateAnsattPeriode)
      ...
      <ArbeidsperioderSøk
        ...
        fillOutFnr={() => {
          document.dispatchEvent(new CustomEvent('feillenke', {
            detail: {
              skjemaelementId: `TwoLevelForm-${personID}-personopplysninger-norskpin-nummer`,
              feilmelding: ''
            } as ErrorElement
          }))
        }}
