...
export interface ArbeidsforholdUtenForsikringProos {
...
const ArbeidsforholdUtenForsikring: React.FC<ArbeidsforholdUtenForsikringProos> = ({
  parentNamespace,
  target,
  typeTrygdeforhold
}: ArbeidsforholdUtenForsikringProos): JSX.Element => {
  ...
  const renderRow = (periodeUtenForsikring: PeriodeUtenForsikring | null, index: number) => {
    ...
    const startdato = index < 0 ? _newStartDato : periodeUtenForsikring?.periode?.startdato
