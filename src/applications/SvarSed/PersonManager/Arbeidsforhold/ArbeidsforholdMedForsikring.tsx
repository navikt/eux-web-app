...
export interface ArbeidsforholdMedForsikring {
...
const ArbeidsforholdMedForsikring: React.FC<ArbeidsforholdMedForsikring> = ({
  parentNamespace,
  target
}:ArbeidsforholdMedForsikring): JSX.Element => {
  ...
  const addPeriodeFromArbeidsgiver = (selectedArbeidsgiver: Arbeidsgiver) => {
    ...
    let newPerioderAnsattMedForsikring: Array<PeriodeMedForsikring> | undefined = _.cloneDeep(perioder)
    if (!newPerioderAnsattMedForsikring) {
      newPerioderAnsattMedForsikring = []
    }
    newPerioderAnsattMedForsikring = newPerioderAnsattMedForsikring.concat(newPeriodeMedForsikring).sort((a, b) =>
        ...
        <AlignStartRow key={arbeidsgiver.arbeidsgiversOrgnr} className='slideInFromLeft'>
          <Column>
            <ArbeidsgiverBox
              ...
              selected={_.find(perioder, (p: PeriodeMedForsikring) =>
