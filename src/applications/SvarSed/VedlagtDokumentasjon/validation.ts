...
export const validateVedlagtDokumentasjon = (
  ...
  const isAnnetSelected = sed.vedlagtDokumentasjon?.forhaandsdefinerteDokumenter?.includes('annet')
  const annetDokumenter = sed.vedlagtDokumentasjon?.annetDokument
