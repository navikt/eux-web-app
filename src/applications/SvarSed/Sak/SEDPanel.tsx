...
import { Button, Detail, Heading, Link, Loader, Panel } from '@navikt/ds-react'
...
import { findSavedEntry, hasDraft, canEditSed, hasSentStatus } from 'applications/SvarSed/Sak/utils'
