...
export const isPreviewableSed = (sedType: string): boolean =>
  ['F001', 'F002', 'F003', 'F026', 'F027', 'H001', 'H002', 'H021', 'H065', 'H120', 'S040', 'S046', 'U002', 'U004', 'U017', 'X001', 'X002', 'X003', 'X004', 'X008', 'X009', 'X010', 'X011', 'X012'].indexOf(sedType) >= 0

export const usesTypedSedApi = (sedType: string | null | undefined): boolean =>
  ['H021', 'H120', 'H065', 'X002', 'X003', 'X004'].indexOf(sedType ?? '') >= 0
