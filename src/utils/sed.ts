...
export const isU013Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'U013'
...
export const isH065Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'H065'

export const isH120Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'H120'

export const isH021Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'H021'

export const isH070Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'H070'

export const isS040Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'S040'

export const isS046Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'S046'

export const isX001Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X001'

export const isX002Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X002'

export const isX003Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X003'

export const isX004Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X004'

export const isX007Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X007'

export const isX005Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X005'

export const isX006Sed = (replySed: ReplySed | PDU1 | null | undefined): boolean => (replySed as ReplySed)?.sedType === 'X006'
...
export const isPreviewableSed = (sedType: string): boolean =>
  ['F001', 'F002', 'F003', 'F026', 'F027', 'H001', 'H002', 'H003', 'H005', 'H006', 'H021', 'H065', 'H070', 'H120', 'S040', 'S046', 'U002', 'U004', 'U013', 'U017', 'X001', 'X002', 'X003', 'X004', 'X005', 'X006', 'X007', 'X008', 'X009', 'X010', 'X011', 'X012'].indexOf(sedType) >= 0

export const usesTypedSedApi = (sedType: string | null | undefined): boolean =>
  ['H003', 'H005', 'H006', 'H021', 'H120', 'H065', 'H070', 'U013', 'X002', 'X003', 'X004', 'X005', 'X006', 'X007'].indexOf(sedType ?? '') >= 0
