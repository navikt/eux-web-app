...
const allowed:Allowed = {
  ...
  ALLOWED_SAKSHANDLINGER: ["H001", "F002", "F026", "X001", "X009", "Delete_Case"],
  ...
  ALLOWED_SED_EDIT_AND_UPDATE: ["H001", "H002", "F001", "F002", "F003", "U002", "U004", "U017", "X001", "X008", "X009", "X010", "X011", "X012"]
}
