...
export type SedAction = 'X002' | 'X003' | 'X004' | 'X008' | 'X010' | 'X011' | 'X012' | 'X013' | 'U002' | 'U004' | 'U013' | 'U017' | 'F002' | 'H002' | 'Read' | 'Update' | 'Delete' | 'Send' | 'ReadParticipants' | 'Participants_Send'
