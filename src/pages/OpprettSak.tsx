                  ...
                  <AlertStripe type='advarsel'>
                    ...
                    {serverInfo && (
                      <Lenke
                        ...
                        ariaLabel={t('ui:label-createNewCaseInGosys')}
                        target='_blank'
                      >
                        {t('ui:label-createNewCaseInGosys')}
                      </Lenke>
                    )}
                    <VerticalSeparatorDiv />
                  </AlertStripe>
            ...
            <Row>
              <Column>
                ...
                <AlertStripe type='suksess'>
                  <FlexDiv>
                    <span>
                      {t('ui:label-caseNumber') + ': ' + opprettetSak.rinasaksnummer}
                    </span>
