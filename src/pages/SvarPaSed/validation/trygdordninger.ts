...
export const validateTrygdordninger = (v: Validation, t: any, options: any, personID: string): void => {
  ...
  validatePeriod('perioderMedArbeid')
  validatePeriod('perioderMedTrygd')
  validatePeriod('perioderMedITrygdeordning')
  validatePeriod('perioderUtenforTrygdeordning')
  validatePeriod('perioderMedYtelser')
  validatePeriod('perioderMedPensjon')
