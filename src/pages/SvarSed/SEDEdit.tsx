          ...
          {showMainForm() && (
            <>
              <MainForm<ReplySed>
                ...
                forms={[
                  { label: t('el:option-mainform-personopplysninger-u013'), value: 'personopplysningerU013', validationValue: 'personopplysninger', component: PersonOpplysninger, type: 'U013' },
