...
import SisteAnsettelsesForhold, { Barn, F002Sed, FSed, HSed, ReplySed } from 'declarations/sed'
import Arbeidsperioder, { CreateSedResponse, LocalStorageEntry, Validation } from 'declarations/types'
