          ...
          <>
            <MainForm<ReplySed>
              ...
              forms={[
                ...
                { label: t('el:option-mainform-adresser'), value: 'adresser', component: Adresser, type: ['F', 'H'], adult: true, barn: true, condition: () => CDM_VERSJON <= 4.3 },
                { label: t('el:option-mainform-adresser'), value: 'adresser', component: Adresser, type: ['F', 'H002'], adult: true, barn: true, condition: () => CDM_VERSJON >= 4.4},
