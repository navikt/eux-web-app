          ...
          <>
            <MainForm<ReplySed>
              ...
              forms={[
                ...
                { label: t('el:option-mainform-adresser'), value: 'adresser', component: Adresser, type: ['F', 'H002'], adult: true, barn: true },
                { label: t('el:option-mainform-adresse'), value: 'adresse', component: Adresser, type: ['S'], options: {singleAdress: true}},
                { label: t('el:option-mainform-adresse-h001'), value: 'adresse-h001', component: AdresseH001, type: ['H001'], adult: true, barn: true},
